...
Captura de Code Coverage para ver en las DevTools cuanto JavaScript y CSS se usa
...
Código de JavaScript donde se usa un import dinámico para cargar la dependencia de canvas-confetti al hacer clic en un botón
